...
const FEATURES = [
  ...
  },
  {
    ...
    desc: "Upload and share high-quality video exports with no quality loss.",
  ...
  },
  {
    ...
    desc: "Clients approve edits or request changes with a single click.",
    color: "text-rose-500",
    bg: "bg-rose-50",
  },
  {
    ...
    desc: "Generate private download links for final deliverables that you control.",
    color: "text-zinc-500",
    bg: "bg-zinc-50",
  },
];
...
const STEPS = [
  ...
  {
    n: "03",
    title: "Deliver Final Video",
    desc: "Share the finished project with a clean, professional download link.",
  },
];
      ...
      <nav className={`fixed top-0 inset-x-0 z-50 transition-all duration-300 ${
        ...
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <button
              onClick={goToLogin}
              className="text-sm font-semibold bg-zinc-900 text-white px-5 py-2 rounded-xl hover:bg-zinc-700 transition-colors shadow-sm"
            >
              Get Started
            </button>
          </div>
      ...
      <section className="relative pt-32 pb-24 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm border border-zinc-200 rounded-full px-4 py-1.5 mb-8 shadow-sm">
            ...
            <span className="text-xs font-medium text-zinc-600">Built exclusively for filmmakers</span>
          </div>
          ...
          <p className="text-xl text-zinc-500 max-w-2xl mx-auto mb-10 leading-relaxed">
            Share edits, collect feedback, manage projects, and deliver final videos in one streamlined platform.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-zinc-900 tracking-tight">
              Everything you need<br />to deliver great work
            </h2>
          </div>
      ...
      <section id="how" className="py-24 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-zinc-900 tracking-tight">
              From first draft<br />to final delivery
            </h2>
          </div>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <div className="bg-gradient-to-br from-zinc-900 to-zinc-800 rounded-3xl p-14 shadow-2xl relative overflow-hidden">
            ...
            <h2 className="relative text-3xl md:text-4xl font-bold text-white mb-4 tracking-tight">
              Start collaborating with your<br />clients the right way.
            </h2>
            <p className="relative text-zinc-400 mb-8 text-base">
              Join filmmakers who use FilmOS to deliver work professionally.
            </p>
            <button
              onClick={goToLogin}
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex flex-col items-center md:items-start gap-2">
            ...
            <p className="text-xs text-zinc-400 max-w-xs text-center md:text-left">
              The filmmaker's platform for client collaboration, video review, and file delivery.
            </p>
          </div>
