      ...
      },
      {
        ...
        elements: [
          ...
          },
          {
            ...
            width: 38,
            height: 50,
            content: "Strategic Vision\n\nWe begin with understanding your brand, market, and objectives. This foundation guides every decision we make.\n\nCreative Excellence\n\nOur team brings expertise and innovation to deliver solutions that exceed expectations.",
            fontSize: 13,
            color: "#4a4a5e",
            fontFamily: "'Inter', sans-serif",
            lineHeight: 1.6
          },
          {
            ...
            width: 38,
            height: 50,
            content: "Precision Execution\n\nWe manage every detail with precision, ensuring timely delivery and quality outcomes.\n\nPartnership Approach\n\nYour success is our success. We maintain transparency and collaboration throughout.",
            fontSize: 13,
            color: "#4a4a5e",
            fontFamily: "'Inter', sans-serif",
            lineHeight: 1.6
